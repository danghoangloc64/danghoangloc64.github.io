...
### 3.3 Xuất dữ liệu đơn hàng
- Xuất danh sách đơn hàng ra file PDF
- Xuất danh sách đơn hàng ra file Excel

---

## 4. Lịch sử vận chuyển & kế hoạch ngày

### 4.1 Lịch sử vận chuyển
...
### 4.2 Kế hoạch vận chuyển theo ngày
...
## 6. Quản lý tài chính – sổ quỹ

### 6.1 Phiếu thu – phiếu chi
...
### 8.2 Chức năng quản lý người dùng
(Chỉ dành cho Admin)
- Thêm tài khoản mới
